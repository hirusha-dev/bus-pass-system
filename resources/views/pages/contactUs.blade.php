        ...
        <section class="w-full xl:py-24 lg:py-20 py-12 bg-slate-50 border-b border-gray-300">
            <div class="w-full max-w-7xl px-6 lg:px-8 mx-auto">
                <div
                    ...
                    <div>
                        <div class="font-light text-gray-500 sm:text-lg mb-10">
                            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 text-start">
                                Reservations and Contact Details</h2>
                            <p class="mb-4">Booking your stay
                                at
                                Mihintale Circuit Bungalow is easy! For reservations, contact us at +94 25 226 6649. You can
                                also reach out to our caretakers, Mr. Thushara (+94 77 600 4148) or Mr. Jayasooriya (+94 77
                                674
                                1299), who will be happy to assist you.
                            </p>
                        </div>
                        <div class="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                            <div
                                class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-indigo-600">
                                <a href="javascript:;"
                                    ...
                                    <svg class="fill-white transition-all duration-500 group-hover:fill-indigo-600"
                                ...
                                <p
                                    ...
                                    We offer a range of secure and convenient methods to assist you with all your financial
                                    transactions. Our team is always here to help you every step of the way.</p>
                            </div>
                            <div
                                class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-indigo-600">
                                <a href="javascript:;"
                                    class="w-14 h-14 bg-indigo-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                                    <svg class="stroke-white transition-all duration-500 group-hover:stroke-indigo-600"
                                        width="30" height="30" viewBox="0 0 30 30" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <p
                                    class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                                    Have questions or need assistance? Reach out to us directly via phone. We’re here to
                                    provide support and ensure all your needs are met with care and efficiency. </p>
                            </div>
                        </div>
